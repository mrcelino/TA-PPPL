Feature: Cart functionality
  ...
  Scenario: User adds a product to cart successfully
    When the user clicks pesan on a product from "Ayam Sehatku Cabang Yogyakarta"
  ...
  Scenario: User cannot add product from a different store to cart
    And the user adds a product from "Ayam Sehatku Cabang Yogyakarta" to the cart
